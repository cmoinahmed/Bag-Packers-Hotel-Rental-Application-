...
import com.ty.backpackers.respository.AdminRepository;
import com.ty.backpackers.service.AdminService;
...
public class AdminController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "SUCCESS"),
			@ApiResponse(code = 404, message = "ADMIN DETAILS NOT FOUND") })
	@GetMapping(value = "/phone/{phone}", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	...
	public ResponseEntity<ResponseStructure<Admin>> adminValidateByEmail(@RequestParam String email,@RequestParam String password){
	...
	public ResponseEntity<ResponseStructure<Admin>> adminValidateByPhone(@RequestParam long phone,@RequestParam String password){
